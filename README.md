`ICECovid_Scrape.py` scrapes ICE websibe (https://www.ice.gov/coronavirus) and provides up-to-date staff and detainee COVID-19 infections and deaths in a CSV file. 
